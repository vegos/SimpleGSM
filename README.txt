...
What I did is a jumper wire from pin 2 to JP (the left one, close to the
antenna).
Now, I can soft-power-on the shield using pin D2 instead of 9 (as D9 is used
by LCD shield).
...
Arduino Leonardo has hardware support for TTL serial in pins D0, D1 (as for
uploading sketches is using USB CDC communications).

So you don't have to use SoftwareSerial library!
